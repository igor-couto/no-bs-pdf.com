...
COPY index.html styles.min.css app.min.js icon.svg og-image.svg buy-me-a-coffe.svg kofi.svg site.webmanifest robots.txt sitemap.xml /usr/share/nginx/html/
